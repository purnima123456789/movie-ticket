...
public class SeatController {
	...
	public ResponseEntity<Boolean> blockSeat(@RequestBody @PathVariable("id") int seatId) {
	...
	public ResponseEntity<Boolean> bookSeat(@RequestBody @PathVariable("id") int seatId) {
	...
	public ResponseEntity<Boolean> cancelSeat(@RequestBody @PathVariable("id") int seatId) {
