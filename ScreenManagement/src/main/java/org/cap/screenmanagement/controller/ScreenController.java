...
public class ScreenController {
	...
	public ResponseEntity<Boolean> deleteScreen(@RequestBody @PathVariable("id") int screenId) {
	...
	public ResponseEntity<Screen> fetchScreenById(@RequestBody @PathVariable("id") int screenId) {
